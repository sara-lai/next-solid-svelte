// basically our backend app here
...
fastify.get("/", async function rootHandler(request, reply) { // only naming functions for stack traces
  return reply.sendFile("index.html");
});

// handwritten protocol just to see
